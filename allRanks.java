...
/**
 * Write a description of allRanks here.
 * 
 * @author (Patrick) 
...
// Each of these csv files represents a single year (e.g., "yob_1960.csv") and has three columns: birth name (e.g., "Mary"), gender ("M" or "F"), and the total births by that name/year
